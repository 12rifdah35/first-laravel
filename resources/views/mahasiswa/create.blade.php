          ...
          <div class="col-sm-12">
            ...
            <form action="" method="POST">
              <div class="row">
                ...
                <div class="col-sm-6">
                  <table for="">Nama mahasiswa</table>
                  <input type="text" name="Nama_mahasiswa" class="form-control" placeholder="input Nama_mahasiswa">
                </div>
                <div class="col-sm-6">
                  <table for="">Tanggal lahir</table>
                  <input type="date" name="tgl_lahir" class="form-control">
                </div>
                <div class="col-sm-6">
                  <table for="">prodi</table>
                 <select name="prodi" id="form-control ">
